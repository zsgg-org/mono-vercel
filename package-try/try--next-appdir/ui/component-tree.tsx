            ...
            <div className="flex gap-x-1">
              ...
              >
                <span className="tabular-nums">
                  {item.type === 'client' ? item.size / 1000 : <CountUp start={item.size / 1000} end={0} />}
                </span>{' '}
                KB
              </div>
            </div>
  ...
  return (
    <Boundary animateRerendering={false} labels={['Component Tree']}>
      <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="space-y-3 rounded-lg bg-gray-900 p-4">
              ...
              <div className="overflow-hidden rounded-full bg-gray-700">
                <div
                  className={clsx('bg-vercel-blue h-2 animate-[translateXReset_1s_ease-in-out_1_reverse] rounded-full')}
                  style={{
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-x-3 text-sm text-gray-400">
                <div className="bg-vercel-blue rounded-md px-2 py-0.5 text-xs tracking-widest text-white/50">{'</>'}</div>
        ...
        <div className="text-vercel-orange text-sm italic">Note: The component bundle sizes are not yet accurate.</div>
      </div>
    </Boundary>
  );
};
