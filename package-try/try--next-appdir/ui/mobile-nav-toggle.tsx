...
const MobileNavContext = React.createContext<[boolean, React.Dispatch<React.SetStateAction<boolean>>] | undefined>(undefined);

export function MobileNavContextProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      >
        ...
        {isOpen ? <XIcon className="block w-6 text-gray-300" /> : <MenuAlt2Icon className="block w-6 text-gray-300" />}
      </button>
